...
MIGRATION_MODULES = {"sites": "afi_backend.contrib.sites.migrations"}
...
TEMPLATES = [{
    ...
    "OPTIONS": {
        ...
        "context_processors": [
            ...
            "afi_backend.utils.context_processors.settings_context",
        ],
    },
}]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "afi_backend.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "afi_backend.users.adapters.SocialAccountAdapter"
# django-compressor
# ------------------------------------------------------------------------------
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=env("JWT_TOKEN_LIFETIME_MINUTES", default=5))
}
