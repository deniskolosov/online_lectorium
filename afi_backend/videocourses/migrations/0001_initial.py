    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('1'), default_currency='RUB', max_digits=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='videocourses.VideoCourse')),
                ('lecture_test', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='videocourses.LectureTest')),
                ('lecturer', models.ForeignKey(blank=True, help_text='Set if different from course', null=True, on_delete=django.db.models.deletion.CASCADE, to='events.Lecturer')),
            ],
        ),
    ]
